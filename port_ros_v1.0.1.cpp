...
Controller::Controller(ros::NodeHandle& n){
	...
	connectPort(port_name,baud_rate);
        ros::Subscriber sub = n.subscribe("cmd_vel", 10, &Controller::chatterCallback, this);
        ros::Publisher cmd_pub = n.advertise<nav_msgs::Odometry>("command", 10);
	ros::Timer spin_timer = n.createTimer(ros::Duration(1 ),&Controller::spinCallback, this);
...
int main(int argc, char **argv)
{
	...
	Controller C(n);
	//ros::Timer spin_timer = n.createTimer(ros::Duration(1 / hz),&Controller::spinCallback, &C);
